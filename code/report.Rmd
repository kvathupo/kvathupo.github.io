...
Finally, we create and test our human portfolio.
...
ggplot(data=pfolio, aes(x=date, y=val)) +
  geom_line(color="#FC4E07") +
  geom_line(data=pfolio_monkey, aes(x=date, y=val), color="#00AFBB") +
  labs(title="Portfolio Value over time",
         x = "Date",
         y = "Total Value (Dollars)") + 
  theme(plot.title = element_text(hjust = 0.5))
...
theoretical monkeys in the area of asset management. It does not, however,
